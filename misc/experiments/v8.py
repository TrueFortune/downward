...
BUILDS = ["release"]
REVISIONS = ["70cdf58", "1fe9d94"] # latest normal commit from 2026-01-19 and latest unrolling_options commit from 2026-01-22
CONFIG_NICKS = [
...
SUITE = ["drones-horndl", "queens-horndl", "psr-middle", "psr-large"] # all suites + those that use unrolling
