...
from custom_report import create_comparative_report, create_scatter_plot_report, arithmetic_mean
...
BUILDS = ["release"]
REVISIONS = ["1fe9d94"] # latest commit from  2025-01-22
CONFIG_NICKS = [
    ("eager-greedy-add-unrolling", ["--search", "eager_greedy([add(axioms=exact_negative_cycles)])"]),
    ("eager-greedy-add-unrolling-prune", ["--search", "eager_greedy([add(axioms=exact_negative_cycles, unrolling_options=[prune_unreachable])])"]),
    ("eager-greedy-add-unrolling-replace", ["--search", "eager_greedy([add(axioms=exact_negative_cycles, unrolling_options=[replace_propagation_axioms])])"]),
    ("eager-greedy-add-unrolling-small", ["--search", "eager_greedy([add(axioms=exact_negative_cycles, unrolling_options=[only_small_cycles])])"]),
]
...
SPECIAL_ATTRIBUTES = [Attribute("default_value_axioms", absolute=True),
                      Attribute("default_value_axioms_percentage", function=arithmetic_mean, absolute=True),
...
exp.add_step("make-comparison-tables", create_comparative_report, [exp, CONFIG_NICKS, REVISIONS, ATTRIBUTES, 4, False])
...
exp.add_step("make_scatter_plots", create_scatter_plot_report, [exp, CONFIG_NICKS, REVISIONS, SCATTER_ATTRIBUTES, 4])
